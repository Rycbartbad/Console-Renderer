...
class Transform {
public:
    static void translate(class Mesh& mesh, const Vec4& translation);
    static void translate(Vec4& pos, const Vec4& translation);
    static void rotate(class Mesh& mesh, const Vec4& center, Vec4 axis, float angle);
    static void rotate(class Mesh& mesh, Vec4 axis, float angle);
